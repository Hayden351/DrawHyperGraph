...
import draw.CommandLineConfigurable;
import draw.Converter;
...
public class TestCommandLineConfigurable
{
    ...
    {
        @Override public Object convert (List<String> t) { return new Color (Integer.parseInt(t.get(0)), Integer.parseInt(t.get(1)), Integer.parseInt(t.get(2)));}
...
//    public static float x;
    ...
    @CommandLineConfigurable(converter=GenerateColor.class, neededParameters=3, description="Testing values that are ordered triples")
    ...
    public static void main (String[] args) throws InstantiationException, IllegalAccessException
    {
        ...
        {
            CommandLineConfigurable annotation = f.getAnnotation(CommandLineConfigurable.class);
